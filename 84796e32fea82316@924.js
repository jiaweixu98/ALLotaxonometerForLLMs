...
function _plot_balance(DivergingBarChartBalance,bal_dat,width,d3){return(
DivergingBarChartBalance(bal_dat, {
  x: d => d.frequency,
  y: d => d.y_coord,
  xFormat: "%",
...
function _DivergingBarChartBalance(d3){return(
function DivergingBarChartBalance(data, {
...
JSON.parse(`[{"y_coord":"total count","frequency":0.247},{"y_coord":"total count","frequency":-0.753},{"y_coord":"exclusive names","frequency":0.86},{"y_coord":"exclusive names","frequency":-0.1}]`)
)}

export default function define(runtime, observer) {
  const main = runtime.module();
  main.variable(observer()).define(["md"], _1);
  main.variable(observer("plot_balance")).define("plot_balance", ["DivergingBarChartBalance","bal_dat","width","d3"], _plot_balance);
  main.variable(observer("DivergingBarChartBalance")).define("DivergingBarChartBalance", ["d3"], _DivergingBarChartBalance);
